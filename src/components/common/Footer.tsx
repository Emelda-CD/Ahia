    ...
    <footer className="bg-card border-t">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div>
            <h3 className="text-xl font-bold text-primary mb-4">Ahia</h3>
            <p className="text-muted-foreground">Your trusted online marketplace in Nigeria.</p>
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-2">Subscribe to our newsletter for the latest deals.</p>
