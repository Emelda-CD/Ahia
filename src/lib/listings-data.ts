...
export const allListings: Listing[] = [
  ...
  {
    id: '21',
    title: 'Spacious Shop for Rent at Abakpa',
    description: 'Large shop space in a busy commercial area. Ideal for supermarket or warehouse.',
    price: 1200000,
    category: 'property',
    image: 'https://placehold.co/600x400.png',
    data_ai_hint: 'shop storefront',
  ...
  {
    id: '22',
    title: 'Office Complex for Sale in GRA',
    description: 'A modern office complex with multiple floors and ample parking space.',
    price: 150000000,
    category: 'property',
    image: 'https://placehold.co/600x400.png',
    data_ai_hint: 'office building',
    location: { lga: 'Enugu North', town: 'GRA' },
    propertyVerified: true,
    verifiedSeller: true,
    rating: 5.0,
  ...
  {
    id: '23',
    title: '2-Bedroom Apartment in New Haven',
    description: 'A cozy and well-maintained 2-bedroom apartment with constant water supply.',
    price: 1800000,
    category: 'property',
    image: 'https://placehold.co/600x400.png',
    data_ai_hint: 'apartment building',
